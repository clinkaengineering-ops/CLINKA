/** Letters with optional internal hyphens/apostrophes (e.g. O'Brien, Mary-Jane). */
...
export const ACCOUNT_HOLDER_NAME_MESSAGE =
  "Enter the account holder's full legal name (first and last name) using letters, spaces, hyphens, or apostrophes only.";
