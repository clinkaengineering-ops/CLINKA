...
exports.scanMessageContent = scanMessageContent;
const FLAGGED_REASON = "Sharing contact information or external links is not allowed on this platform.";
const PATTERNS = [
...
function scanMessageContent(text) {
